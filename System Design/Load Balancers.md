...
4. **IP hash load balancer** : It hashes the ip of the client and consistently sends requests to the same server decided depending on the hashed version of the clients.  It might be useful for legacy apps that 